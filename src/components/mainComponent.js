  ...
  return (
    <div class="grid justify-center">
      ...
      <div className='grid pt-8 gap-8 custom_pattern_blue xl:grid-cols-[29%_29%] justify-center'>
        <PostComponent thumbnail = {react_portfolio_thumbnail} title="React/Tailwind portfolio site" content={postText3} stack={["HTML5", "React", "JS", "Tailwind", "CSS3", "Test", "Test", "Test"]} link="https://github.com/FEDavid/portfolio"/>
